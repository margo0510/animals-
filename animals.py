...
#ANIMALS_WIDTH, ANIMALS_HEIGHT = 20,20
...
#dog = pygame.transform.rotate(pygame.transform.scale(dog_image, dog_size), 30)

dog = pygame.transform.scale(dog_image, dog_size)

target_rect = dog.get_rect()
print(target_rect)
...
#cat = pygame.transform.rotate(pygame.transform.scale(cat_image, cat_size), 30)

cat = pygame.transform.scale(cat_image, cat_size)

target_rect_2 = cat.get_rect()
print(target_rect_2)
